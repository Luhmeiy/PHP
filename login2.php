...
<div class="row">
	<!-- login com Facebook -->
	<div class="col-md-6">
	    <div class="fb-login-button" data-size="large" data-button-type="continue_with" data-layout="default" data-auto-logout-link="true" data-use-continue-as="false" data-width="" data-target="FB.api" onclick="login()"></div>
	</div>
	<!-- login com Google -->
	<div class="col-md-6">
